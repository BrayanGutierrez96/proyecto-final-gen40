...
import imgMistakes from '../../assets/12-mistakes.png'
import imgStore from '../../assets/store-cannabis.png'
import imgQuality from '../../assets/quality.png'
...
const Education = () => {
    ...
    <section className="education">
        <div className="education-header ">
            ...
            <a className='education__education-header__link' href="#">Show All</a>
        </div>
